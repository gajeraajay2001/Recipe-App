...
class FoodCourtPage extends StatefulWidget {
  @override
  _FoodCourtPageState createState() => _FoodCourtPageState();
}
            ...
            child: Column(
              children: [
                  ...
                  onTap: () {
                    setState(() {
                      Navigator.of(context)
                        ...
                        return SecondPage(
                          image: "asset/images/court2.jpg",
                          url:
                              "https://www.youtube.com/watch?v=UGnYu88A2Ws&t=92s",
                          name: "Idli",
                          ...
                          text3: "salt",
                          text4:
                              "soak it for 3-4 hours. not more than 4 hours.",
                          ...
                          text16:
                              "Grind the rice until it becomes smooth paste.",
                        );
                      }));
                    });
                  },
                  child: Temp(
                    image1: "asset/images/court2.jpg",
                    color: Color(0xfff4a261),
                  ),
                ),
                SizedBox(height: 10),
                InkWell(
                  ...
                  child: Temp(
                    image1: "asset/images/court1.jpg",
                    color: Color(0xffe76f51),
                  ),
                ),
                SizedBox(height: 10),
                InkWell(
                  ...
                  child: Temp(
                    image1: "asset/images/court3.jpg",
                    color: Color(0xffcb997e),
                  ),
                ),
                SizedBox(height: 10),
                InkWell(
                  ...
                  child: Temp(
                    image1: "asset/images/court4.jpg",
                    color: Color(0xffd4a373),
                  ),
                ),
                SizedBox(height: 10),
                ...
                InkWell(
                  ...
                  child: Temp(
                    image1: "asset/images/court5.jpg",
                    color: Color(0xff118ab2),
                  ),
                ),
                SizedBox(height: 10),
